...
def send_email(addr_to, msg_subj, msg_text):
    addr_from = "irina.2011.14@mail.ru"                         # Отправитель
    password  = "ndfhmvhfpm228"                                   # Пароль
...
addr_to   = "franlyaguh@gmail.com"                                # Получатель
...
send_email(addr_to, "Тема сообщения", "Текст сообщения")